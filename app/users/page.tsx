...
export default function UsersPage() {
  ...
  async function previewPatient(member: Member) {
    if (!member.user_id || !(await confirmDialog({ title: 'Acceder como paciente', message: `Cambiarás temporalmente a la cuenta de ${member.full_name || member.email}.`, confirmLabel: 'Acceder', tone: 'default' }))) return;
